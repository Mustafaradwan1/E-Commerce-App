...
const Cart = () => {
  ...
  return <>
      ...
      {AllCart.length > 0 ? 
      <div className=' lg:flex mt-40 gap-2'>
          ...
          <div key={item.id} className='border-b border-gray-300 last:border-none mt-2 pb-2'>
            ...
            <div className='sm:flex justify-between items-center '>
                <Link href={`product${item?.id}`} className="flex items-center justify-center gap-2">
                  <img src={item?.thumbnail} alt="img" className="w-20"  />
                  <div className=''>
                    <p>{item.title}</p>
      ...
      <div className='flex-1 '>
       ...
       : 
        <div className='bg-white mt-40 w-full py-10 my-2 flex flex-col justify-center items-center gap-4'>
