...
const ShoppingCart = () => {
  ...
  return <div>
    <Link to={"/Cart"} className='hover:shadow-lg group hover:shadow-teal-500 transition relative ml-5 bg-gray-200 h-10 w-10 rounded-full flex justify-center items-center cursor-pointer text-gray-900 z-50'>
